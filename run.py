...
if __name__ == '__main__':
    ...
    DefaultParam = {
        ...
        # net, "total": both}
        "train_mode": "decision",
        "data_dir":               "E:/DATA/3_fold/fold_2/dilate_17/train_set/",  # train数据路径
        "path_which_folder_test": "E:/DATA/3_fold/fold_2/dilate_17/",  # testing的时候文件夹前部分
        "train_test_visualization": "/forloss/visualization3/",  # testing可视化保存路径
        "learn_rate": 1,  # 0.001

        "log_time_dir": "E:/DATA/3_fold/log_log/",
        "epochs_num": 50,
        "batch_size": 1,
